...
**Posso editar metadados do pacote depois que ele é carregado?**
...
Consulte [Gerenciando proprietários de pacotes em NuGet.org](../nuget-org/publish-a-package.md#managing-package-owners-on-nugetorg).
...
![Erro ao fazer logon para contas do AAD](media/unmanaged-aad-tenant.png)
