...
* Desinstale a compilação mais antiga. Você precisará executar VS como administrador para fazer isso.
...
* Alternado o pacote de feed do ATOM para um ponto de extremidade do serviço OData: se você atualizar para a versão CTP2 do NuGet, certifique-se de adicionar a URL a seguir como uma origem de pacote: [http://go.microsoft.com/fwlink/?LinkID=204820](http://go.microsoft.com/fwlink/?LinkID=204820).
