...
---
# <a name="40-rc-release-notes"></a>Notas de Versão do 4.0 RC
...
* dotnet pack3 deve incluir documentação XML por padrão – [#3698](https://github.com/NuGet/Home/issues/3698)
...
* Dotnet restore realiza as pesquisas de Id que diferencia maiúsculas de minúsculas nos repositórios locais de lista simples quando versões flutuantes são usadas – [#2516](https://github.com/NuGet/Home/issues/2516)
...
* dotnet restore3 foo.csproj deve seguir as dependências de projectref e restaurá-los também. Como o build. - [#3577](https://github.com/NuGet/Home/issues/3577)
