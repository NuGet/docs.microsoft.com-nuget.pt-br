...
- [`IVsPackageProjectMetadata`](#ivspackageprojectmetadata-interface): métodos para recuperar informações sobre um projeto em que as ações do NuGet estão sendo executadas.
