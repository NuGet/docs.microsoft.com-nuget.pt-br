...
### [Console de Gerenciador de pacotes (PowerShell)](tools/package-manager-console.md)
## Configurar o NuGet
...
## [Criar um pacote usando o MSBuild](reference/msbuild-targets.md)
...
## [CLI do dotnet](tools/dotnet-Commands.md)
