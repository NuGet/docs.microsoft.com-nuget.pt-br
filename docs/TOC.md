# [Visão rápida dos documentos](index.yml)
...
### [adicionar](reference/cli-reference/cli-ref-add.md)
...
### [restaurar](reference/cli-reference/cli-ref-restore.md)
...
### [atualizar](reference/cli-reference/cli-ref-update.md)
