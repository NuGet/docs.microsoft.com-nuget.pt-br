...
# [Instalar ferramentas de cliente do NuGet](install-nuget-client-tools.md)
...
## [Instalando pacotes](consume-packages/ways-to-install-a-package.md)
### [Pacotes assinados](consume-packages/installing-signed-packages.md)
...
### [adicionar](tools/cli-ref-add.md)
### [config](tools/cli-ref-config.md)
### [excluir](tools/cli-ref-delete.md)
### [help or ?](tools/cli-ref-help.md)
### [init](tools/cli-ref-init.md)
### [instalar](tools/cli-ref-install.md)
...
### [sinal](tools/cli-ref-sign.md)
### [origens](tools/cli-ref-sources.md)
### [spec](tools/cli-ref-spec.md)
### [atualizar](tools/cli-ref-update.md)
...
## [Frameworks de destino](reference/target-frameworks.md)
...
## Extensibilidade
### [Plug-ins multiplataforma do NuGet](reference/extensibility/NuGet-Cross-Platform-Plugins.md)
### [Plug-in de autenticação multiplataforma do NuGet](reference/extensibility/nuget-cross-platform-authentication-plugin.md)
...
### [Impacto do project.json](archive/project-json-impact.md)
# API
...
### [Enviar pacotes de símbolos por push](api/symbol-package-publish-resource.md)
