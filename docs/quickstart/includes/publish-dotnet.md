1. <span data-ttu-id="00d04-101">Altere para a pasta que contém o arquivo `.nupkg`.</span><span class="sxs-lookup"><span data-stu-id="00d04-101">Change to the folder containing the `.nupkg` file.</span></span>
