...
---
# <a name="quickstart-create-and-publish-a-nuget-package-using-visual-studio-net-standard"></a>Início Rápido: Criar e publicar um pacote do NuGet usando o Visual Studio (.NET Standard)
