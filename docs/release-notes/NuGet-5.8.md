...
* Verificar pacotes NuGet assinados com o novo [`dotnet nuget verify`](/dotnet/core/tools/dotnet-nuget-verify) comando- [#8051](https://github.com/NuGet/Home/issues/8051)
