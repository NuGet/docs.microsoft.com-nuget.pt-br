...
O NuGet 2.8.7 foi lançado 27 de julho de 2015 como um patch de atualização para o 2.8.6 VSIX com correção específica a um bug que afetado a implementação da política do Powershell.
