...
* O feed de pacote foi alternado do ATOM para um ponto de extremidade de serviço OData: se você atualizar para a versão CTP2 do NuGet, certifique-se de adicionar a seguinte URL como uma origem de pacote: `https://feed.nuget.org/ctp2/odata/v1/`.
* O comando Add-Package foi renomeado para *install-Package*.
* O formato de `.nuspec` foi atualizado. O formato de `.nuspec` agora inclui o campo *iconUrl* para especificar um ícone de 32-png que será exibido na caixa de diálogo Adicionar pacote. Portanto, certifique-se de definir isso para distinguir seu pacote. O formato de `.nuspec` também inclui o novo campo *projectUrl* , que você pode usar para apontar para uma página da Web que fornece mais informações sobre o pacote.

Essa compilação não funcionará com arquivos de `.nupkg` antigos. Se você obtiver exceções de referência nulas, estará usando um arquivo de `.nupkg` antigo e precisará recriá-lo com a [ferramenta de linha de comando do NuGet](http://nuget.codeplex.com/releases/52017/download/165468)atualizada.
...
* [Executar o nupack. exe em uma pasta com apenas um arquivo nuspec deve usar o nuspec](http://nuget.codeplex.com/workitem/52)
...
* [&ldquo;Adicionar referência de pacote&hellip;&rdquo; aparece no menu de contexto das referências instaladas](http://nuget.codeplex.com/workitem/85)
...
* [O desempenho do Remove-Package para um pacote que não está instalado é inválido](http://nuget.codeplex.com/workitem/117)
...
* [NuPack. exe não deve permitir um elemento vazio &lt;licenseurl&gt;](http://nuget.codeplex.com/workitem/152)
* [Renomear lista-pacote para obter pacote, adicionar pacote a instalar e remover pacote para desinstalar-Package](http://nuget.codeplex.com/workitem/155)
...
* [Se você executar o pacote de lista sem feeds, obterá um erro de referência nulo](http://nuget.codeplex.com/workitem/164)
...
* [init. ps1 não está sendo acionado no pacote personalizado](http://nuget.codeplex.com/workitem/237)
...
* [Padrão a caixa de diálogo Adicionar pacote aos pacotes instalados](http://nuget.codeplex.com/workitem/254)
...
* [NuPack/NuGet-erro do console do Gerenciador de pacotes do&gt;](http://nuget.codeplex.com/workitem/335)
...
* [Instalação de mesclagem &amp; adicionar comandos PS](http://nuget.codeplex.com/workitem/3)
...
* [Adicionar o cabeçalho do Apache a um arquivo COPYRIGHT. txt](http://nuget.codeplex.com/workitem/36)
* [Remover o comando Update-PackageName](http://nuget.codeplex.com/workitem/37)
...
* [Alterar o parâmetro-local do pacote de lista para instalado](http://nuget.codeplex.com/workitem/129)
