...
| `dotnet restore` | O mesmo que `nuget restore` para projetos .NET Core. Consulte [dotnet restore](https://docs.microsoft.com/dotnet/articles/core/tools/dotnet-restore). |
